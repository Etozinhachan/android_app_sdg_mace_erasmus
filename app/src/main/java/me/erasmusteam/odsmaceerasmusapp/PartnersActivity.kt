...
class PartnersActivity : AppCompatActivity(), IFragmentHolder, IExpandableListHolder {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupExpandableListView(this, this@PartnersActivity, jwt_token!!, is_admin!!, header_username!!)

        val webViewFragment: WebViewFragment = WebViewFragment.newInstance("https://sites.google.com/es-loule.edu.pt/mace/partners")
